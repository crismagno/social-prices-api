...
@Injectable()
export class ProductItemsValidationService {
	...
	constructor() {
		this._logger = new Logger(ProductItemsValidationService.name);
	}
	...
	public validateProductItemsUploadTemplate(row: ExcelJS.Row): void {
		if (
